...
$string['settings:secret'] = 'Server Secret';
$string['settings:secret_help'] = 'Optionally, specify the secret for the ONLYOFFICE Document Server, if it is required. If the Document Server has no secret set, leave it blank!';
